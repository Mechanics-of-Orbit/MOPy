...
if __name__ == '__main__':
    ...
    from modules.DB.call_database import *
...
class Calculate:
    ...
    def other_var(pos_vec, vel_vec):
        ...
        K = [0, 0, 1]
        n_vec = cross(K,h_vec)
        Calculate.position_of_n_vector(n_vec)
        return [h_vec, n_vec]
    ...
    def OE(pos_vec, vel_vec, mu):
        ...
        OE_values = {"Semi-Major Axis": sma, "Inclination": inc*180/pi, "Vec_Eccentricity": e_vec, "Norm_Eccentricity": e_norm}
...
if __name__ == '__main__':
    ...
    OE = Calculate.OE(pos_vec, vel_vec, 3.986e5)
    print(OE)
