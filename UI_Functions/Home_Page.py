...
################################################################################
## Form generated from reading UI file 'Home_PagetDzXgS.ui'
##
...
#endif // QT_CONFIG(tooltip)
        self.combosearchbox.setItemText(0, QCoreApplication.translate("MainWindow", u"                                Choose the option from the Drop-down ", None))
